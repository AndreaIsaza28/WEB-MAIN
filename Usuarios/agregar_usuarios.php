...
<div class="columns">
    <div class="column is-one-third">
        <h2 class="is-size-2">Nuevo Usuario</h2>
        <div class="field">
        ...
        <div class="field">
            ...
            <div class="control">
                <input name="CLAVE" class="input" id="CLAVE" type="text" placeholder="Clave" required></input>
            </div>
        </div>
        <div class="field">
        ...
        <div class="field">
            <div class="control1">
                <button id="btnGuardar" class="button is-success">Registrar</button>
            </div>
        </div>
    </div>
</div>
